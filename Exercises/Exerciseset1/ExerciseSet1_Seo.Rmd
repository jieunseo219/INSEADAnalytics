...
**Your Answers here:**
<br> 1. File: dataSet1.R,  mytickers = c("SPY", "AAPL", "YHOO"). Change mytickers to "AAPL" to get the data of Apple
<br> 2. Cumulative: 5.9707339 / Average: 0.001479369 / standard deviation: 0.023881.
<br> 3. First edit the 'dataSet1.R' file in the line mytickers = c("SPY", "AAPL", "YHOO"). Than run the code with "YHOO". For Yahoo, Cumulative: 2.908048 / Average: 0.0007205272 / Standard deviation: 0.0301775
<br>
...
**Your Answers here:**
<br> 1. Number of rows: nrow(transposedData), which is 3 and Number of columns ncol(transposedData), which is 4036
<br> 2. portfolio = apply(StockReturns,c(1,2),mean)
<br> names(portfolio_transpose) <- rownames(StockReturns)
<br>
<br>
<br>
...
**Your Answers here:**
<br> In 'dataSet1.R' file, I have to change startDate = "2001-01-01" and run the data to make it work
<br>
<br>
<br>
