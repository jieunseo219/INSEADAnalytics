...
getwd()
setwd("C:/Users/Ji Eun Seo/Documents/INSEADAnalytics/Exercises/Exerciseset2")
list.files()
```
...
1. 6 factors (52.29%)
<br>
2. 0.93 for 5 year T-notes 
<br>
3. Suggested component names: 
<br>
Component 1. Government Bond and Notes<br>
Component 2. FX <br>
Component 3. EU Stock Index <br>
Component 4. NA Stock INdex<br>
Component 5. EU FX Futures <br>
Component 6. Oil & Gas<br>
Component 7. Industrial metals <br>
Component 8. Commodity<br>
Component 9. Precious metals <br>
Component 10. E.Asian Stock Index<br> 
<br>
...
<br> 1. The code is varied by "MAfreq" which sequences in intervals of 20 from 10 to 250.
<br> 2. When changed, it changes the time intervals (frequency of trading strategy). Change in return as well.
